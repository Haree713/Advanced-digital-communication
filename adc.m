...
for ii_sim = 1: N_sim
    ...
    for ii_snr = 1:length(SNR_dB)
        ...
        % decision statistics
        Z_SC = conj(H(i_max)) * Y(i_max, :);  % Add your code here
        ...
        % decision statistics
        Z_EQ = ones_vector' * Y; % Add your code here
...
% Perform phase compensation and combine the signals
for i = 1:N
    % Phase compensation: Multiply each received signal by the complex conj
    Y_compensated = exp(-1j * phi(i)) * Y(i, :);
    % Combine compensated signals
    Z_EQPC = Z_EQPC + Y_compensated;
end
        
        % decision statistics
%         Z_EQPC = % Add your code here
        ...
        % decision statistics
        Z_SD = conj(H(ii_branch)) * Y(ii_branch, :);% Add your code here
